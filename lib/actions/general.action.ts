...
// ✅ Get latest interviews (not belonging to the user)
...
export async function createFeedback(params: CreateFeedbackParams) {
  ...
  try {
    ...
    const {
      ...
      model: google("gemini-2.0-flash-001"), // ✅ fixed (only 1 arg)
      schema: feedbackSchema,
      //structuredOutputs: false, // ✅ moved here
      prompt: `
...
// ✅ Get feedback by interviewId + userId
